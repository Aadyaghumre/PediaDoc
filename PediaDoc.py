...
while True:
    try:
            ...
            for kw in dictionary.dictn:
                if kw in command:
                    ...
                    if dictionary.dictn[kw][0] == "ImgSpch":                
                        image = pygame.image.load("Images/"+dictionary.dictn[kw][2]+".jpg").convert_alpha() 
                        image1=pygame.transform.scale(image, (800,500))
                        screen.blit(image1,(300,100))
                        pygame.display.update()
        ...
        keypress ="none" 
        bg1=pygame.image.load("images/bg1.jpg").convert_alpha()
        image=pygame.transform.scale(bg1, (1000,1000))
        screen.blit(image,(0,0))
        pygame.display.update()               
